...
public class Playing extends State implements Statemethods {
	...
	private BufferedImage backgroundImg, cloud, shipImgs[];
	...
	public Playing(Game game) {
		...
		cloud = LoadSave.GetSpriteAtlas(LoadSave.CLOUDS);
	...
	private void drawClouds(Graphics g) {
		for (int i = 0; i < 4; i++)
			g.drawImage(cloud, i * CLOUD_WIDTH - (int) (xLvlOffset * 0.3), (int) (100 * Game.SCALE), CLOUD_WIDTH, CLOUD_HEIGHT, null);
	...
	private void setDrawRainBoolean() {
		// 20% chance of rain every time a level loads
